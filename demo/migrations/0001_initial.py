# Generated by Django 2.2 on 2020-03-19 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.CharField(blank=True, max_length=50, null=True, verbose_name='percentage rate of people sex')),
                ('bysex', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='bySex', to='demo.CoronaComorbidity')),
            ],
        ),
        migrations.CreateModel(
            name='CoronaAge',
            fields=[
                ...
                ('byage', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='byAge', to='demo.CoronaComorbidity')),
            ],
        ),
    ]
